...
class PhoneBookRow extends React.Component {
	...
	personInfo(){
		...
		document.getElementById("filteredSearch").innerHTML = "<h2>" + this.state.name + "</h2>" + "<p><strong>Email:</strong> <a href='mailto:" + this.state.eid +  "@example.com'>" + this.state.eid +  "@example.com</a><br /><strong>Phone Number:</strong> " + this.state.number + "<br /><strong>Office:</strong> " + this.state.room + "</p>";
	}
	render(){
		return(
			<tr>
